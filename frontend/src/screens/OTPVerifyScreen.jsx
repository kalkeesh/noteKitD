...
export default function OTPVerifyScreen({ route, navigation }) {
  ...
  const onVerifyOtp = async () => {
    try {
      setSubmitting(true);
      const data = await apiRequest('/api/verify-otp', 'POST', { email, otp });
      toast.success('OTP verified successfully.');
      navigation.navigate('NewPassword', { email, resetToken: data?.resetToken || '' });
    } catch (err) {
      showAppAlert('Verification failed', getAuthErrorMessage(err, 'Please check the OTP and try again.'));
    } finally {
      setSubmitting(false);
    }
  };
      ...
      >
        <View style={styles.inner}>
          ...
          >
            ...
            <Text style={styles.logoTagline}>OTP Verification</Text>
          </Animated.View>
...
//     try {
//       setSubmitting(true);
//       await apiRequest('/api/verify-otp', 'POST', { email, otp });
//       showAppAlert('Verified', 'OTP verified successfully.');
...
//           onSubmitEditing={onVerifyOtp}
//         />
//         <PrimaryButton title={submitting ? 'Verifying...' : 'Verify OTP'} onPress={onVerifyOtp} disabled={submitting} />
//       </View>
//     </KeyboardScreen>
//   );
// }
